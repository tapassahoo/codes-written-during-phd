...
C      DIMENSION PSIREIN1(NJRTP),PSIIMIN1(NJRTP)
      ...
      DIMENSION UU(NSTATE,NSTATE),W(NSTATE),Z(NSTATE,NSTATE)
      ...
      DO I=1,N_R
        DO J=1,N_T
          ...
          DO K=1,N_P
            ...
            UU(3,3)=V33(JJ)
            MATZ=1
            CALL RS(NSTATE,NSTATE,UU,W,MATZ,Z,FV1,FV2,IERR)
            IF(JJ.EQ.1)THEN
              DO I1=1,NSTATE
                DO J1=1,NSTATE
                  ZTEMP(I1,J1)=Z(I1,J1)
            ...
            IF(JJ.GT.1)THEN
              DO L1=1,NSTATE
                ZZZ(L1)=0.0D0 
                DO K1=1,NSTATE
                  ZZZ(L1)=ZZZ(L1)+ZTEMP(K1,L1)*Z(K1,L1)
                ENDDO
...
!
     ...
     2RMST,RINV,SN_G,RHOD,SINN,COSN,SIND,COSD,SIN2D,
     2V11,V12,V13,V21,V22,V23,V31,V32,V33,
...
!$OMP$ PHI,RSTAR,AAP,VALP,PSIRE,ZP,PSIIM,ISTEP)
...
C      PARAMETER (N_R=256,N_T=64,N_P=128)
