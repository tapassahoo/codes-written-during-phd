...
CCCCCC
      CALL DEFAK(DR,AKR)
      CALL INITIAL_WEIGHT(EKIN0,AM,CKI)
...
CCCCCC
      IF(ISTEP.EQ.1053)THEN
        DO I=N_R/2+5,N_R
          URTR(I)=PSIRE(I)
          URTI(I)=PSIIM(I)
C         WRITE(80,'(1X,5F12.6)')R(I),URTR(I),URTI(I)
        ENDDO
...
CC
      WRITE(6,*)
      WRITE(6,*)'WEIGHT FACTOR FOR OUTGOING WAVE FUNCTION'
      WRITE(6,*)
      DO I=1,10
