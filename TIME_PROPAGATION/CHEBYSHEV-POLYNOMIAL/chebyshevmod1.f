...
CCCCCC
      ...
      T=0.0D0
      DDT=0.01D0
      NCHEB=INT(DDT*(EMAX-EMIN)/2.0D0/HBAR+0.5D0)
      NCHEB=NCHEB+10
      WRITE(*,*)'CHEBYSHEV'
      WRITE(*,*)EKIN,DDT*(EMAX-EMIN)/2.0D0/HBAR,NCHEB
CCCCCC
...
CCCCCC
      MMM=NCHEB
      CALL CHEBYSHEV(BSL,MMM,RAV,DDT,EMAX,EMIN,AKR,V0,PSIRE,PSIIM,PSI)
      RAV=RAV*VOLEM
...
CCCCCC
      ...
      END
CCCCCC
      SUBROUTINE CHEBYSHEV(BSL,NN,RAV,T,EMAX,EMIN,AKR,V0,
     1PSIRE,PSIIM,PSI)
      IMPLICIT REAL*8(A-H,O-Z)
